...
- [Architectural Styles](docs/architectural-styles)
...
- [Microservices](docs/microservices/microservices.md)
  ...
  - [Tools](docs/microservices/tools)
...
- [Cloud Native](docs/cloud-native)
  ...
  - [CI-CD](docs/cloud-native/devops/azure-devops.md)
    - [Github Actions](docs/cloud-native/devops/github-actions.md)  
    - [Jenkins](docs/cloud-native/devops/jenkins.md)  
  ...
  - [Kubernetes](docs/cloud-native/kubernetes/kubernetes.md)    
    ...
    - [Nginx Ingress](docs/cloud-native/kubernetes/nginx-ingress.md) 
    - [Traefik Ingress.md](docs/cloud-native/kubernetes/traefik-ingress.md)    
  - [Platform As a Service](docs/cloud-native/platform-as-a-service)
