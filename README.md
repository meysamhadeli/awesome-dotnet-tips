...
- [Csharp](docs/csharp/csharp.md)
  ...
  - [Versions]()
    - [7](docs/csharp/versions/7.md)
    - [8](docs/csharp/versions/8.md)
    - [9](docs/csharp/versions/9.md)
    - [10](docs/csharp/versions/10.md)
    - [11](docs/csharp/versions/11.md)
...
- [DotNet](docs/dotnet/dotnet.md)
  ...
  - [Versions]()
    - [dotnet5](docs/dotnet/versions/dotnet5.md)
    - [dotnet6](docs/dotnet/versions/dotnet6.md)
    - [dotnet7](docs/dotnet/versions/dotnet7.md)
