...
- [Outbox meets change data capture (feat. .NET, PostgreSQL, Kafka and Debezium)](https://www.youtube.com/watch?v=4rnSzEd9jPI)

## 🚀 Samples
- [joaofbantunes/PostgresChangeDataCaptureOutboxSample](https://github.com/joaofbantunes/PostgresChangeDataCaptureOutboxSample)
- [oskardudycz/PostgresOutboxPatternWithCDC.NET](https://www.youtube.com/watch?v=WcmLvoxs9ps)
