...
- [Stitch's DESIGN.md format is now open-source](https://stitch.withgoogle.com/docs/design-md/overview/)

## 🚀 Samples

- [google-labs-code/design.md](https://github.com/google-labs-code/design.md) - A format specification for describing a visual identity to coding agents. DESIGN.md gives agents a persistent, structured understanding of a design system.
- [alchaincyf/huashu-design](https://github.com/alchaincyf/huashu-design) - Huashu Design · HTML-native design skill for Claude Code · Claude Code